    ...
    return (
      <nav className="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <Link className="navbar-brand brand-logo text-logo" to="/">TechnoSham</Link>
          <Link className="navbar-brand brand-logo-mini text-logo-mini" to="/">TS</Link>
        </div>
              ...
              <Dropdown alignRight>
                <Dropdown.Toggle className="nav-link count-indicator">
                  ...
                  <div className="nav-language-text">
                    <p className="mb-1"><Trans>English</Trans></p>
                  </div>
                </Dropdown.Toggle>
                <Dropdown.Menu className="preview-list navbar-dropdown">
                  <Dropdown.Item className="dropdown-item d-flex align-items-center" href="!#" onClick={evt =>{evt.preventDefault(); setLanguage('ar');}}>
                    <div className="nav-language-icon mr-2">
                      <i className="flag-icon flag-icon-ae" title="ae" id="ae"></i>
                    </div>
                    <div className="nav-language-text">
                      <p className="mb-1"><Trans>Arabic</Trans></p>
                    </div>
                  </Dropdown.Item>
                  <div className="dropdown-divider"></div>
                  <Dropdown.Item className="dropdown-item d-flex align-items-center" href="!#" onClick={evt =>{evt.preventDefault(); setLanguage('en');}}>
                    <div className="nav-language-icon mr-2">
                  ...
                  <div className="dropdown-divider"></div>
                  <Dropdown.Item className="dropdown-item d-flex align-items-center" href="!#" onClick={evt =>{evt.preventDefault(); setLanguage('tr');}}>
                    <div className="nav-language-icon mr-2">
                      <i className="flag-icon flag-icon-tr" title="TR" id="tr"></i>
                    </div>
                    <div className="nav-language-text">
                      <p className="mb-1"><Trans>Turkish</Trans></p>
                    </div>
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
